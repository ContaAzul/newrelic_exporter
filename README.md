...
```console
docker run -p 9112:9112 -v /path/to/my/config.yml:/config.yml -e "NEWRELIC_API_KEY=${NEWRELIC_API_KEY}" 439291037095.dkr.ecr.us-east-2.amazonaws.com/microservice/newrelic_exporter
```
